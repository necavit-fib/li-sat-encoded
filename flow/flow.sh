...
# Flow Free automated solver script
...
function usage {
	echo "usage: flow-solver [-s output_file] instance_file.pl"
...
echo "including solver logic (file: flow-solver.pl) to $solver_file"
cat flow-solver.pl >> $solver_file

#append display functions
echo "including display functions to $solver_file"
cat displayFlow.pl >> $solver_file
